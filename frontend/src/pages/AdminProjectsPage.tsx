        ...
        <tbody>
            {projects.map((p) => (
                <tr key={p.projectId}>
                    ...
                    <td>
                        <button className="btn btn-primary btn-sm w-100 mbf-1" onClick={() => setEditingProject(p)}>Edit</button>
                        <button className="btn btn-danger btn-sm w-100 mbf-1"  onClick={() => handleDelete(p.projectId)}>Delete</button>
